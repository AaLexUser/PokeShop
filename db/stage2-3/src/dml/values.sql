...
INSERT INTO pokemonwiki values (DEFAULT,'Bulbasaur', 1, 'Seed Pokémon', 0.7, 6.9, 1, 'https://static.wikia.nocookie.net/pokemon/images/2/21/001Bulbasaur.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Ivysaur', 2, 'Seed Pokémon', 1.0, 13.0, 2, 'https://static.wikia.nocookie.net/pokemon/images/7/73/002Ivysaur.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Venusaur', 3, 'Seed Pokémon', 2.0, 100.0, 3, 'https://static.wikia.nocookie.net/pokemon/images/a/ae/003Venusaur.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Charmander', 4, 'Lizard Pokémon', 0.6, 8.5, 4, 'https://static.wikia.nocookie.net/pokemon/images/7/73/004Charmander.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Charmeleon', 5, 'Flame Pokémon', 1.1, 19.0, 5, 'https://static.wikia.nocookie.net/pokemon/images/4/4a/005Charmeleon.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Charizard', 6, 'Flame Pokémon', 1.7, 90.5, 6, 'https://static.wikia.nocookie.net/pokemon/images/7/7e/006Charizard.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Squirtle', 7, 'Tiny Turtle Pokémon', 0.5, 9.0, 7, 'https://static.wikia.nocookie.net/pokemon/images/3/39/007Squirtle.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Wartortle', 8, 'Turtle Pokémon', 1.0, 22.5, 8, 'https://static.wikia.nocookie.net/pokemon/images/0/0c/008Wartortle.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Blastoise', 9, 'Shellfish Pokémon', 1.6, 85.5, 9, 'https://static.wikia.nocookie.net/pokemon/images/0/02/009Blastoise.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Caterpie', 10, 'Worm Pokémon', 0.3, 2.9, 10, 'https://static.wikia.nocookie.net/pokemon/images/5/5d/010Caterpie.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Metapod', 11, 'Cocoon Pokémon', 0.7, 9.9, 11, 'https://static.wikia.nocookie.net/pokemon/images/c/cd/011Metapod.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Butterfree', 12, 'Butterfly Pokémon', 1.1, 32.0, 12, 'https://static.wikia.nocookie.net/pokemon/images/d/d1/012Butterfree.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Weedle', 13, 'Hairy Bug Pokémon', 0.3, 3.2, 13, 'https://static.wikia.nocookie.net/pokemon/images/d/df/013Weedle.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Kakuna', 14, 'Cocoon Pokémon', 0.6, 10.0, 14, 'https://static.wikia.nocookie.net/pokemon/images/f/f0/014Kakuna.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Beedrill', 15, 'Poison Bee Pokémon', 1.0, 29.5, 15, 'https://static.wikia.nocookie.net/pokemon/images/6/61/015Beedrill.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Pidgey', 16, 'Tiny Bird Pokémon', 0.3, 1.8, 16, 'https://static.wikia.nocookie.net/pokemon/images/5/55/016Pidgey.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Pidgeotto', 17, 'Bird Pokémon', 1.1, 30.0, 17, 'https://static.wikia.nocookie.net/pokemon/images/7/7a/017Pidgeotto.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Pidgeot', 18, 'Bird Pokémon', 1.5, 39.5, 18, 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/018.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Rattata', 19, 'Mouse Pokémon', 0.3, 3.5, 19, 'https://static.wikia.nocookie.net/pokemon/images/4/46/019Rattata.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Raticate', 20, 'Mouse Pokémon', 0.7, 18.5, 20, 'https://static.wikia.nocookie.net/pokemon/images/0/0e/020Raticate.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Spearow', 21, 'Tiny Bird Pokémon', 0.3, 2.0, 21, 'https://static.wikia.nocookie.net/pokemon/images/8/8b/021Spearow.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Fearow', 22, 'Beak Pokémon', 1.2, 38.0, 22, 'https://static.wikia.nocookie.net/pokemon/images/a/a0/022Fearow.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Ekans', 23, 'Snake Pokémon', 2.0, 6.9, 23, 'https://static.wikia.nocookie.net/pokemon/images/f/fa/023Ekans.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Arbok', 24, 'Cobra Pokémon', 3.5, 65.0, 24, 'https://static.wikia.nocookie.net/pokemon/images/c/cd/024Arbok.png');
INSERT INTO pokemontotypes values (24,8);
INSERT INTO entities values (DEFAULT, 'POKEMON');
INSERT INTO pokemon values (24, 24, 22);

INSERT INTO basestats values (DEFAULT, 35, 60, 44, 40, 54, 55);
INSERT INTO pokemonwiki values (DEFAULT,'Pikachu', 25, 'Mouse Pokémon', 0.4, 6.0, 25, 'https://static.wikia.nocookie.net/pokemon/images/0/0d/025Pikachu.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Raichu', 26, 'Mouse Pokémon', 0.8, 30.0, 26, 'https://static.wikia.nocookie.net/pokemon/images/8/88/026Raichu.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Sandshrew', 27, 'Mouse Pokémon', 0.6, 12.0, 27, 'https://static.wikia.nocookie.net/pokemon/images/e/e5/027Sandshrew.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Sandslash', 28, 'Mouse Pokémon', 1.0, 29.5, 28, 'https://static.wikia.nocookie.net/pokemon/images/4/42/Sandslash.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Nidoran', 32, 'Field Monster', 0.4, 7.0, 29, 'https://static.wikia.nocookie.net/pokemon/images/8/80/029Nidoran%E2%99%80.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Nidorina', 30, 'Field Monster', 0.8, 20, 30, 'https://static.wikia.nocookie.net/pokemon/images/c/cd/030Nidorina.png');
...
INSERT INTO pokemonwiki values (DEFAULT,'Nidorino', 33, 'Field Monster', 0.9, 19.5, 32, 'https://img.pokemondb.net/artwork/large/nidorino.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Nidoking', 34, 'Field Monster', 1.4, 62, 33, 'https://img.pokemondb.net/artwork/large/nidoking.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Clefairy', 35, 'Fairy Creature', 0.6, 7.5, 34, 'https://img.pokemondb.net/artwork/large/clefairy.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Clefable', 36, 'Fairy Creature', 1.3, 40, 35, 'https://img.pokemondb.net/artwork/large/clefable.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Vulpix', 37, 'Fox Creature', 1.3, 40, 36, 'https://img.pokemondb.net/artwork/large/vulpix.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Ninetales', 38, 'Fox Creature', 1.1, 19.9, 37, 'https://img.pokemondb.net/artwork/large/ninetales.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Jigglypuff', 39, 'Fairy Creature', 0.5, 5.5, 38, 'https://img.pokemondb.net/artwork/large/jigglypuff.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Wigglytuff', 40, 'Fairy Creature', 1, 12.0, 39, 'https://img.pokemondb.net/artwork/large/wigglytuff.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Zubat', 41, 'Night bat', 0.6, 7.5, 40, 'https://img.pokemondb.net/artwork/large/zubat.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Golbat', 42, 'Night bat', 1.6, 55, 41, 'https://img.pokemondb.net/artwork/large/golbat.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Eevee', 133, 'Evolution', 0.3, 6.5, 42, 'https://img.pokemondb.net/artwork/large/eevee.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Leafeon', 470, 'Verdant', 1, 25.5, 43, 'https://img.pokemondb.net/artwork/large/leafeon.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Vaporeon', 134, 'Bubble Jet', 1, 29, 44, 'https://img.pokemondb.net/artwork/large/vaporeon.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Glaceon', 471, 'Fresh Snow', 0.8, 25.9, 45, 'https://img.pokemondb.net/artwork/large/glaceon.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Shellder', 90, 'Bivalve', 0.3, 4, 46, 'https://img.pokemondb.net/artwork/large/shellder.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Cloyster', 91, 'Bivalve', 1.5, 132.5, 47, 'https://img.pokemondb.net/artwork/large/cloyster.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Lotad', 270, 'Bivalve', 0.5, 2.6, 48, 'https://img.pokemondb.net/artwork/large/lotad.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Lombre', 271, 'Bivalve', 1.2, 32.5, 49, 'https://img.pokemondb.net/artwork/large/lombre.jpg');
...
INSERT INTO pokemonwiki values (DEFAULT,'Ludicolo', 272, 'Bivalve', 1.5, 55.0, 50, 'https://img.pokemondb.net/artwork/large/ludicolo.jpg');
...
-- push all pokemons in instock with random quantity and price
DO $$
BEGIN
    FOR i IN 1..50 LOOP
        INSERT INTO instock values (i, floor(random() * 100 + 1)::integer, floor(random() * 100 + 1)::integer);
    END LOOP;
END$$;
